...
namespace App\Services\Illumination\Validation;
...
class Validator implements ValidatorContract
{
    ...
    protected function initPresenceVerifier()
    {
        global $capsule;

        $connections = $capsule->getDatabaseManager()->getConnections();

        $connectionResolver = new ConnectionResolver($connections);
        $connectionResolver->setDefaultConnection(current(array_keys($connections)));

        $this->setPresenceVerifier(new DatabasePresenceVerifier($connectionResolver));
    }
